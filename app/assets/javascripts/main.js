...
const cities_us = ["New York, New York", "Los Angeles, California",
...
var cities = ["Toronto,Ottawa,Montreal,Vancouver,Calgary,Edmonton,Hamilton,London,Winnipeg,Quebec City,Victoria"];
var states = ["ON", "BC", "MB", "SK", "QC", "NS"];
//const cities_ca =["Toronto,Ottawa,Montreal,Vancouver,Calgary,Edmonton,Hamilton,London,Winnipeg,Quebec City,Victoria"];


const states_us = ["AL", "AK", "AZ", "AR", "CA", "CO", "CT", "DE", "DC", "FL",
...
function getCsvUrl() {
    var csv = $("#results-table").table2CSV({
        delivery: 'value'
    });
...
$(document).ready(function () {
    //var cities
    $(".current_cities").text(cities.slice(0, CITIES_MAX));

    $("#cities_CA").click(function () {
        cities = ["Toronto,Ottawa,Montreal,Vancouver,Calgary,Edmonton,Hamilton,London,Winnipeg,Quebec City,Victoria"];
        states = ["ON", "BC", "MB", "SK", "QC", "NS"];
        $(".current_cities").text(cities.slice(0, CITIES_MAX));
        $('.add-more,.remove-more').hide();
    });

    $("#cities_US").click(function () {
        cities = cities_us.slice(0, CITIES_MAX)
  ...
  "VA", "WA", "WV", "WI", "WY"];
        ...
        $('.add-more').click(function () {
            ...
            if (CITIES_MAX < cities_us.length) {
                CITIES_MAX = CITIES_MAX + 10
                cities = cities_us.slice(0, CITIES_MAX)
            };


            //alert(CITIES_MAX);
            $(".current_cities").text(cities);
